...
pval_sop_datafield_checker <- sop_datafield_checker(merged_df$pvalue, sop$pvalue)
...
par_name_sop_datafield_check <- sop_datafield_check(merged_df$parameter_name , sop$parameter_name)
print(par_name_sop_datafield_check)

# Check pvalue
pval_sop_datafield_check <- sop_datafield_check(merged_df$pvalue, sop$pvalue)
...
## IMPC Disease information csv - CLEANING
...
```{r}
#==== Disease_information.csv — Cleaning =======================================
